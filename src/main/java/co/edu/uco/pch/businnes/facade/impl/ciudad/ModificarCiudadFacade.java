...
import co.edu.uco.pch.businnes.usecase.impl.ciudad.ModificarCiudad;

public class ModificarCiudadFacade implements FacadeWhithoutReturn<CiudadDTO>{
	...
	public void execute(final CiudadDTO dto) {
		...
		try {
			var useCase = new ModificarCiudad(daoFactory);
