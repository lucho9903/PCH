...
public class EliminarCiudad implements UseCaseWithReturn<CiudadDomain, List<CiudadDomain>> {
	...
	public EliminarCiudad(final DAOFactory factory){
        if(ObjectHelper.getObjectHelper().isNull(factory)){
            var mensajeUsuario = "Se ha presentado un porblema tratando de llevar a cabo la eliminacion de las  ciudades";
            var mensajeTecnico = "El DAOFactory para eliminar la ciudad llego nulo...";
