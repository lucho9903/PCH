...
public class ModificarCiudad implements UseCaseWithReturn<CiudadDomain, List<CiudadDomain>> {
	...
	public ModificarCiudad(final DAOFactory factory){
        if(ObjectHelper.getObjectHelper().isNull(factory)){
            var mensajeUsuario = "Se ha presentado un porblema tratando de llevar a cabo la modificacion de las  ciudades";
            var mensajeTecnico = "El DAOFactory para modificar la ciudad llego nulo...";
